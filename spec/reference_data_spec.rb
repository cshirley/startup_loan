...
describe "ReferenceData API" do
  ...
  it "lists all" do
    VCR.use_cassette("reference_data_list_all") do
      ...
      found_reference_type_names = all.inject([]) {|a,rd| a << rd.reference_type_name }
  ...
  it "prevents adding" do
    expect {
      ...
      new_ref_data.save }.to raise_error(StartupLoan::NotSupported)
  end
  ...
  it "prevents updating" do
    VCR.use_cassette("reference_data_prevent_update") do
      ...
      }.to raise_error(StartupLoan::NotSupported)
    end
  end
